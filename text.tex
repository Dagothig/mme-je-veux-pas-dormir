...
\usepackage[paperwidth=5.5in, paperheight=5in, hmargin=0.5in, vmargin=0in, outer=0.75in, inner=0.5in]{geometry}
\usepackage{layout}
...
\node[text width=40pt, xshift=-40pt, yshift=0.25in](jeunesse) at (current page.south east){
...
\txtpage{
Plus tard cette journée-là, Madame Je-Veux-Pas-Dormir décida de faire une marche dehors.

Sur le chemin, elle croisa son ami, monsieur Je-Suis-Pas-Fatigué.
...
Achevé d'imprimer par Msieur-qui-imprime-pour-Ariel à Longueuil.\break
\hspace{0pt}\break
\newpage
...
\node[xshift=-0.125in](gowee) at (current page.center){
    ...
    \begin{tabular} { c c c c c }
        ...
        \mrms{Monsieur}{LETTE}{img/cossin.png} &
