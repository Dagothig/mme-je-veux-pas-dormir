...
\txtpage{
    Arrivé à l'heure du dîner, ils se préparèrent d'excellents sandwiches avant de partir se promener
    un peu. Il y avait un grand parc proche de chez monsieur Je-Suis-Pas-Fatigué qui était parfait.

    Ils s'installèrent à l'ombre d'un grand arbre. Monsieur Je-Suis-Pas-Fatigué s'allongea un petit
    moment.

    -- Merci encore pour... commença madame Fin-De-Phrase. Enfin, ces sandwiches sont
    excellents, surtout le...
